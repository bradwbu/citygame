...
{	// ID                              // DisplayName               //Val, fVal, dontwrite, bitsize, data ptr
	...
	{ kUO_WebHideStats,                "WebHideStats",                0, 0, 0, 1 },
	{ kUO_WebHidePowers,               "WebHidePowers",               0, 0, 0, 1 },
	//
	...
	{ kUO_PopHelpDisable,				"PopHelpDisable",	          0, 0, 0, 1, },
	{ kUO_HideFeePrompt,				"HideFee",					  0, 0, 0, 1, },
	{ kUO_HideUsefulSalvagePrompt,		"HideSalvageWarning",		  0, 0, 0, 1, },
	{ kUO_ForcedPopHelpDisable,			"ForcedPopHelpDisable",       0, 0, 0, 1, },
