...
void serverParseClientEx(const char *str, ClientLink *client, int access_level);
#define serverParseClient(str,client) serverParseClientEx(str,client,0) // ACCESS_USER
