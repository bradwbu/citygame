...
void LoadPetBattleCreatureInfos()
{
    ...
    ParserLoadFiles(0, "defs/petBattleCreatureInfo.def", "petBattleCreatureInfo.bin", PARSER_SERVERONLY, ParsePetBattleCreatureInfoList, &g_petBattleCreatureInfoList, NULL, NULL, NULL);
