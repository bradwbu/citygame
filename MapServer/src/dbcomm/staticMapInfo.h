...
// If none are flagged the map is not an Ouroboros map. Otherwise, it's where
// the Ouroboros portal leads for matching players.
#define MAP_OUROBOROS_HEROES        (1 << 0)
#define MAP_OUROBOROS_VILLAINS        (1 << 1)
#define MAP_OUROBOROS_PRIMAL        (1 << 2)
#define MAP_OUROBOROS_PRAETORIANS    (1 << 3)
