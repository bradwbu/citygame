...
int TVLevel() 
{
    int var = MissionLevel() - TV_LEVEL_ADJUST;
    return var;
}
    ...
    switch (VarGetNumber("WaveCount")) {
        ...
        case 2:
            if (STATE_MINS > 6.0) {
                ...
                Spawn(1, "ReactorAttackers", TV_SPAWNDEF_MIXED, "EncounterGroup:TV_Wave", NULL, TVLevel()-1, MissionNumHeroes());
                DetachSpawn("ReactorAttackers");
                TVNextWave();
            }
            break;
        ...
        case 4:
            if (STATE_MINS > 12.0) {
                // spawn and move to next wave
                Spawn(3, "ReactorAttackers", TV_SPAWNDEF_SUPER_MINIONS, "EncounterGroup:TV_Wave", NULL, TVLevel()-1, MissionNumHeroes());
                DetachSpawn("ReactorAttackers");
                TVNextWave();
            }
            break;
