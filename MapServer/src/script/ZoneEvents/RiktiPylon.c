...
void RiktiPlyonMasterAtArmsSpawn()
{
    ...
    if (RiktiPylonAllowedToPlantBomb(player))
    {
        ...
        for (i = 1; i <= countKillers; i++)
        {
            ...
            if (RiktiPylonAllowedToPlantBomb(killer))
            {
                ...
                // display message
                SendPlayerAttentionMessage(killer, VarGet("BombRewardFloat"));
            }
...
void RiktiPlyonBombExplosionCheck(void)
{
...
void RiktiPlyonBombCleanup(void)
{
    int i, count = VarGetNumber("GlowieCount");
...
//        DoEvery("TeleportTimer", VarGetFraction("TeleportCheckTime"), RiktiPylonTeleportCheckPlayers);  // every second
    ...
    STATE("ShieldDown") ////////////////////////////////////////////////////////
        ...
        ON_ENTRY  
            ...
            BroadcastAttentionMessage(VarGet("ShieldDownFloat"), 0, 0);
        ...
        DoEvery("KillTimer", 0.05f, RiktiPlyonBombExplosionCheck);
    ...
    STATE("ShieldRecovery") ////////////////////////////////////////////////////////
        ...
        ON_ENTRY  
            ...
            BroadcastAttentionMessage(VarGet("ShieldUpFloat"), 0, 0);
