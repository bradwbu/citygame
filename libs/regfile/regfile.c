...
#include <time.h>
    ...
    void printLastError_(void)
    {
        ...
        size_t size = FormatMessageW(FORMAT_MESSAGE_ALLOCATE_BUFFER | FORMAT_MESSAGE_FROM_SYSTEM | FORMAT_MESSAGE_IGNORE_INSERTS, NULL, errorCode, 0,
                                     messageBuffer, sizeof(messageBuffer) / sizeof(wchar_t), NULL);
