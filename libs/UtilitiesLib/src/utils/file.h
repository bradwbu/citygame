...
bool fileIsInsideGameDataDir( const char* aPath );    // true if it's inside one of the gamedata dirs
...
void *fileAllocPhysical_dbg(const char *fname,int align,int *lenp MEM_DBG_PARMS);
