...
CREATE DATABASE [cohacc]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'cohacc', FILENAME = N'C:\MSSQL\MSSQL14.SQLEXPRESS\MSSQL\DATA\cohacc.mdf' , SIZE = 3072KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'cohacc_log', FILENAME = N'C:\MSSQL\MSSQL14.SQLEXPRESS\MSSQL\DATA\cohacc_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [cohacc] SET COMPATIBILITY_LEVEL = 110
GO
...
ALTER DATABASE [cohacc] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO

ALTER DATABASE [cohacc] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
