...
{
    int i;
    ParserLoadFiles("ent_types", ".txt", "ent_types.bin", 0, ParseSeqTypeList, &seqTypeList, NULL, NULL, NULL);
...
SeqType *seqTypeLoadSingleFile(const char *fname)
{
    ...
    if (ParserLoadFiles(NULL, (char*)fname, NULL, 0, ParseSeqTypeList, &dummy_list, NULL, NULL, NULL)) {
