...
#define TRANSPOSE_ARRAY(attrib) \
    TransposeArray(pptab[0]->p##attrib, pattr, (int)offsetof(CharacterAttributes, attrib), iNum, fDefault)
 ...
 * CalcResistance
 *
 * This is no longer auto-generated since it was hand-optimized.
 *
 */
