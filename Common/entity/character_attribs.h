...
typedef enum ESpecialAttrib
{
	...
	kSpecialAttrib_PowerRedirect		= sizeof(CharacterAttributes) + 36,
	kSpecialAttrib_MagicCarpet			= sizeof(CharacterAttributes) + 37,
	kSpecialAttrib_TokenAdd				= sizeof(CharacterAttributes) + 38,
	kSpecialAttrib_TokenSet				= sizeof(CharacterAttributes) + 39,
	kSpecialAttrib_TokenClear			= sizeof(CharacterAttributes) + 40,
	kSpecialAttrib_LuaExec				= sizeof(CharacterAttributes) + 41,
	kSpecialAttrib_ForceMove			= sizeof(CharacterAttributes) + 42,
	kSpecialAttrib_ParkourRun			= sizeof(CharacterAttributes) + 43,
} ESpecialAttrib;
