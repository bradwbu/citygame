...
public:
    ...
    char const* GetMagicWord(int iWhichMagicWord);
...
private:
    ...
    void FoundMagicWordAutoTestChild(char const* pSourceFileName, Tokenizer *pTokenizer);
    void FoundMagicWordAutoTestGroup(char const* pSourceFileName, Tokenizer *pTokenizer);
    void FoundMagicWordAutoTest(char const* pSourceFileName, Tokenizer *pTokenizer);
    void FoundMagicWordAutoTestBlock(char const* pSourceFileName, Tokenizer *pTokenizer);
    void DoPreWriteOutFixup(void);
    void PrependParentGroupNames(AUTO_TEST_STRUCT *pAutoTest);
    void GetAtestFileName(char outName[MAX_PATH], char const* pInName);

    AUTO_TEST_STRUCT *FindTestByName(char const* pName);

    void CreateAtestFile(char const* pFileName);
