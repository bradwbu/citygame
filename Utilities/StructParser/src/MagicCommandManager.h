...
private:
    char const* GetArgDescriptionBlock(enumMagicCommandArgType eArgType, char *pArgName, char *pTypeName,
    ...
    char const* GetReturnValueMultiValTypeName(enumMagicCommandArgType eArgType);
    ...
    void FoundCommandMagicWord(char const* pSourceFileName, Tokenizer *pTokenizer, bool bIsRemoteCommand, bool bIsSlowCommand, bool bIsQueuedCommand);
    void FoundCommandVarMagicWord(char const* pSourceFileName, Tokenizer *pTokenizer, enumMagicCommandArgType eType);
    ...
    char *GetErrorFunctionName(char const* pCommandName);
    ...
    void CommandAssert(MAGIC_COMMAND_STRUCT *pField, bool bCondition, char const* pErrorMessage);
    ...
    char const* GetGenericTypeNameFromType(enumMagicCommandArgType eType);
