...
char const* AutoRunManager::GetMagicWord(int iWhichMagicWord)
{
...
void AutoRunManager::ResetSourceFile(char const* pSourceFileName)
{
    int i = 0;
...
void AutoRunManager::AddAutoRun(char const* pFuncName, char const* pSourceFileName)
{
    AddAutoRunWithBody(pFuncName, pSourceFileName, NULL, NULL, AUTORUN_ORDER_INTERNAL);
}

void AutoRunManager::AddAutoRunWithBody(char const* pFuncName, char const* pSourceFileName, char const* pDeclarations, char const* pCode, int iOrder)
{
...
void AutoRunManager::AddAutoRunSpecial(char const* pFuncName, char const* pSourceFileName, bool bCheckIfAlreadyExists, int iOrder)
{
