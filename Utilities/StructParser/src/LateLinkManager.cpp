...
char const* LateLinkManager::GetMagicWord(int iWhichMagicWord)
{
...
void LateLinkManager::FoundMagicWord(char const* pSourceFileName, Tokenizer *pTokenizer, int iWhichMagicWord, char const* pMagicWordString)
{
    Tokenizer tokenizer;
