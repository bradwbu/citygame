...
public:
    ...
    void FoundAutoTransMagicWord(char const* pSourceFileName, Tokenizer *pTokenizer);
    void FoundAutoTransHelperMagicWord(char const* pSourceFileName, Tokenizer *pTokenizer);
...
private:
    ...
    void AddFieldToLockToArg(ArgStruct *pArg, char const* pFieldName, 
        enumAutoTransFieldToLockType eFieldToLockType, int iIndexNum, char const*pIndexString);
    void AddRecurseFunctionToArg(ArgStruct *pArg, int iArgNum, char const* pFuncName, bool bIsATRRecurse, char const* pFieldString);
    int FindFuncByName(char const* pString);
    enumAutoTransArgType GetArgTypeFromString(char const* pArgTypeName);
    ...
    void FuncAssert(AutoTransactionFunc *pFunc, bool bExpression, char const* pErrorString);

    char const* GetTargetCodeArgTypeMacro(AutoTransactionFunc *pFunc, ArgStruct *pArg);
    char const* GetTargetCodeArgGettingFunctionName(ArgStruct *pArg);
    ...
    bool IsFullContainerFunction(char const* pFuncName, int iArgNum, char const* pArgTypeName);
    bool IsFullContainerFunction_NoFields(char const* pFuncName, int iArgNum, char const* pArgTypeName);
    ...
    void AddFieldReferenceToHelperFuncMagicArg(Tokenizer *pTokenizer, HelperFuncArg *pArg, char const* pFieldString);
