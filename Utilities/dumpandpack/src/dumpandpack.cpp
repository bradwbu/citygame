...
void *fileAlloc(const char *fname,int *lenp)
{
    FILE    *file;
...
int removeFromZip(const char *zipfilename, const char *srcfilename)
{
...
int addtozip(const char *zipfilename, const char *srcfilename)
{
    zipFile zipfile=0;
    int ret=1;
...
const char *starts[] = {"Windows", "Product", "System", "Process"};
