...
//         GetComputerName(compname, &len);
        ...
        for( i = eaSize(&s_hwndsEdit) - 1; i >= 0; --i)
        {
            s_origEditWndProc = (WNDPROC)SetWindowLongPtr(s_hwndsEdit[i], GWLP_WNDPROC, (LONG_PTR)wndproc_Edit);
