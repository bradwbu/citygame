...
* Open **Source\3rdparty\IJGWin32\IJGWin32.sln** in Visual Studio 2010 and build all configurations
...
2. dbserver in "Full Debug" configuration crashes during startup
3. The game client doesn't start due to runtime library conflicts