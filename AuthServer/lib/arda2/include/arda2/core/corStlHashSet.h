...
class HashSet : public std::unordered_set<KeyType, corHashTraitsAux<Traits> > { };

template < typename KeyType,
           class Traits = corHashTraits<KeyType> >
class HashMultiSet : public std::unordered_multiset<KeyType, corHashTraitsAux<Traits> > { };
